        ...
        <Container className={`${isVisible ? "visible" : ""}`}>
          ...
          <List>
            <Li>
              <Paragraph>
                ...
                "us" or "our") respects the privacy of users (hereinafter "you"
                or "user") and makes every effort to protect the personal
                information you choose to provide to us. This Privacy Policy
                describes our practices regarding the collection, use and
                disclosure of your information through your use of our websites,
                applications and services (collectively, the "Data").
              </Paragraph>
            </Li>
            <Li>
              <Paragraph>
                <ParagraphSpan>Data</ParagraphSpan> is any information that is
                directly or indirectly related to the users of the website.
              </Paragraph>
            </Li>
          </List>
          ...
          <Section>
            ...
            <List>
              ...
              <Li>
                <Line />
                <ParagraphLine>
                  Data on devices and their use: IP address, time, date of use
                  of the website by the user, software, as well as browser,
                  operating system and other data revealed by the user.
                </ParagraphLine>
              </Li>
              ...
              <Li>
                <Line />
                <ParagraphLine>
                  Data from surveys related to improving the provision of
                  services to users; information obtained by the website as a
            ...
            <List>
              <Li>
                <Paragraph>
                  ...
                  <ParagraphSpan> cookies</ParagraphSpan> are small pieces of
                  data that are sent to the user's computer when you visit a web
                  page or view an advertising module on a web page and are
                  stored on the user's computer or mobile device.
                </Paragraph>
              </Li>
              <Li>
                <Paragraph>
                  <ParagraphSpan>Pixels</ParagraphSpan> or{" "}
                  <ParagraphSpan>pixel tags </ParagraphSpan> are digital images,
                  an element of the ad matrix that form the image. They can be
                  used to track how often a user uses a web page, to identify
                  the user's browser and provide services. For example, storing
                  data in the shopping cart between visits, and preventing
            ...
            <List>
              <Li>
                <Paragraph>
                  ...
                  powers and duties assigned to the Website in accordance with
                  the <ParagraphSpan>current legislation of</ParagraphSpan>
              ...
              <Li>
                <Paragraph>
                  The conditions of data processing and storage are determined
                  on the basis of the purposes of data processing, as well as on
                  the basis of the conditions established in the contracts
                  concluded with users, in accordance{" "}
                  <ParagraphSpan>
            ...
            <List>
              <Li>
                <Paragraph>
                  ...
                  well-being and human rights, in particular but not
                  exclusively:
                </Paragraph>
              </Li>
              <Li>
          ...
          <Section>
            ...
            <List>
              ...
              <Li>
                <Paragraph>
                  The site shall continuously monitor the security measures
                  taken.
                </Paragraph>
              </Li>
            </List>
          ...
          <Section>
            ...
            <List>
              <Li>
                <Paragraph>
                  The administration of the site reserves the right to change
                  the provisions of this privacy policy at any time.
                </Paragraph>
              </Li>
              <Li>
                <Paragraph>
                  If the user does not agree with the changes, the user
                  undertakes to immediately cease all interaction with the
                  website.
                </Paragraph>
              </Li>
              <Li>
              ...
              <Li>
                <Paragraph>
                  The user, by entering his/her personal data or by providing
                  this data in any other way, or by performing actions on the
                  website, agrees to the privacy policy and authorises the
                  website as well as third party service providers to process
                  his/her data.
                </Paragraph>
              </Li>
              <Li>
              ...
              <Li>
                <Paragraph>
                  ...
                  <ParagraphSpan>sdproduction.org</ParagraphSpan> website if
                  they do not agree to the terms of the privacy policy and must
                  stop using the website.
                </Paragraph>
              </Li>
              <Li>
                <Paragraph>
                  The user acknowledges that in case of his negligence in
                  security and protection of his data and data for
                  authorisation, such as password, login, third parties may gain
                  unauthorised access to his account and user data.{" "}
                  <ParagraphSpanWithUnderLine>
